...
that the primary forms of retrival are suported. In an interview with
...
pdf, etc), youtube, Google Searches, and while IPFS isn't widley used,
...
benificial. While this was not implemented at this time, due to
specifics with intergrations with the other subsystems, we hope to
