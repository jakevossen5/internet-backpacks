...
described in section 1 improves results. To simulate the enviorment
this tool is expeted to be used in, I limited the numbers of cores my
computer gave Python, as well as limit my internet speed using the
Network Link Conditioner Tool[12]. I used the BSD command line utility
\texttt{time}[13] to measure the runtime of the program. Below is a
table describing the benefit from multiple cores based off the
internet speed avaliable.
